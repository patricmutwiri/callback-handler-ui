...
export default function AuthSection() {
  ...
  return (
    <div className="flex flex-col gap-4 p-6 border rounded-lg shadow-sm bg-white/80 backdrop-blur-sm">
      <Text variant="h2" className="text-center">Sign In</Text>
      <Text className="text-sm text-gray-600 text-center">
        Sign in to save your webhooks and access them from anywhere
      </Text>
      ...
      <div className="flex flex-col gap-3">
        ...
        <button
          ...
          className="w-full px-4 py-3 border rounded-lg hover:bg-gray-50 transition-colors flex items-center justify-center gap-3 bg-white"
        >
