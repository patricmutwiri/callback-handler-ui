  ...
  return (
    <div className="min-h-screen flex flex-col">
      <a
        ...
        aria-label="View Callback Handler source on GitHub"
        className="group fixed right-0 top-0 z-50 h-20 w-20 overflow-hidden text-white"
      >
        <span className="absolute right-0 top-0 block h-0 w-0 border-l-[80px] border-t-[80px] border-l-transparent border-t-black transition-colors group-hover:border-t-slate-800" />
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 24 24"
          fill="currentColor"
          aria-hidden="true"
          className="absolute right-3 top-3 h-7 w-7 transition-transform group-hover:scale-110"
        >
